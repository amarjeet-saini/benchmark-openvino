    ...
    def infer(self, exe_network, batch_size, progress_bar=None):
        ...
        while (self.niter and iteration < self.niter) or \
            ...
            if self.api_type == 'sync':
                ...
                #temperature.append(("{:.2f}".format(self.ie.get_metric(metric_name="DEVICE_THERMAL", device_name="MYRIAD"))))
        ...
        #return fps, latency_ms, total_duration_sec, iteration, temperature
