...
Namespace(api_type='async', batch_size=0, cache_dir='', dump_config='', enforce_bfloat16=False, exec_graph_path=None, infer_threads_pinning=None, input_output_precision=None, input_precision=None, layout='', load_config='', number_infer_requests=None, number_iterations=None, number_streams=None, number_threads=None, output_precision=None, path_to_cldnn_config=None, path_to_extension=None, path_to_model='/home/h2/models/mobv2/IR/mobv2_onnx_model.xml', paths_to_input=[['/home/h2/inf/data_clean']], perf_counts=False, progress=False, quantization_bits=None, report_folder='', report_type=None, shape='', stream_output=False, target_device='MULTI:GPU,CPU', time=None)
